...
MIN = 10
starttime = time.time()
img1 = cv2.imread('imgs\\splice_1.png')  # query
img2 = cv2.imread('imgs\\splice_2.png')  # train
...
if len(good) > MIN:
    ...
    cv2.imwrite("imgs\\simplepanorma.png", direct)
    cv2.imwrite("imgs\\bestpanorma.png", warpImg)
